...
impl SimpleRun for Add {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        vm.write_one(engine, self.out, ops::add(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Sub {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // result to the output.
        vm.write_one(engine, self.out, ops::sub(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Mul {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // result to the output.
        vm.write_one(engine, self.out, ops::mul(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Div {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // result to the output.
        vm.write_one(engine, self.out, ops::div(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Neg {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        vm.write_one(engine, self.out, ops::neg(value).at(span)?, span)?;
...
impl SimpleRun for Pos {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        vm.write_one(engine, self.out, ops::pos(value).at(span)?, span)
    }
}
...
impl SimpleRun for Not {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Negate the value and write the result to the output.
        vm.write_one(engine, self.out, ops::not(value).at(span)?, span)?;
...
impl SimpleRun for Gt {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // result to the output.
        vm.write_one(engine, self.out, ops::gt(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Geq {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Compare the left-hand side to the right-hand side and write the
        // result to the output.
        vm.write_one(engine, self.out, ops::geq(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Lt {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Compare the left-hand side to the right-hand side and write the
        // result to the output.
        vm.write_one(engine, self.out, ops::lt(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Leq {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Compare the left-hand side to the right-hand side and write the
        // result to the output.
        vm.write_one(engine, self.out, ops::leq(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Eq {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Compare the left-hand side to the right-hand side and write the
        // result to the output.
        vm.write_one(engine, self.out, ops::eq(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Neq {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // Compare the left-hand side to the right-hand side and write the
        // result to the output.
        vm.write_one(engine, self.out, ops::neq(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for In {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // output.
        vm.write_one(engine, self.out, ops::in_(value, iterator).at(span)?, span)?;
...
impl SimpleRun for NotIn {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // output.
        vm.write_one(engine, self.out, ops::not_in(value, iterator).at(span)?, span)?;
...
impl SimpleRun for And {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // to the output.
        vm.write_one(engine, self.out, ops::and(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for Or {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        // to the output.
        vm.write_one(engine, self.out, ops::or(lhs, rhs).at(span)?, span)?;
...
impl SimpleRun for None {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        ...
        vm.write_one(engine, self.out, Value::None, span)?;
...
impl SimpleRun for Auto {
    fn run(&self, span: Span, vm: &mut Vm, engine: &mut Engine) -> SourceResult<()> {
        // Write the value to the output.
        vm.write_one(engine, self.out, Value::Auto, span)?;
